...
| Поле | Тип | Обязательное | Описание |
|---|---|---|---|
| `type` | String | Да | Тип тарифа |
| `interest_rate` | String | Да | Процентная ставка |
...
|---|---|---|---|
| `id` | long | Да | Идентификатор тарифа |
...
| Поле | Тип | Обязательное | Описание |
|---|---|---|---|
| `userId` | long | Да | Идентификатор пользователя |
| `tariffId` | long | Да | Идентификатор тарифа |
...
| Параметр | Тип | Обязательный | Описание |
|---|---|---|---|
| `orderId` | UUID | Да | Идентификатор заявки |
